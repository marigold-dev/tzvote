 ...
 */
import { r as registerInstance, h, H as Host, f as getElement, d as createEvent, e as readTask, i as forceUpdate, w as writeTask } from './index-847f2fde.js';
import { b as getIonMode, c as config, a as isPlatform } from './ionic-global-1ef19007.js';
...
import { a as attachComponent, d as detachComponent } from './framework-delegate-2b76c681.js';
import { t as transition } from './index-6391de89.js';
  ...
  componentDidLoad() {
    {
      rIC(async () => {
        ...
        if (config.getBoolean('statusTap', isHybrid)) {
          import('./status-tap-823a0df3.js').then((module) => module.startStatusTap());
        }
        if (config.getBoolean('inputShims', needInputShims())) {
          ...
          import('./input-shims-af993f05.js').then((module) => module.startInputShims(config, platform));
        }
