  ...
  test.describe(title('select: expanded highlight'), () => {
    test.describe('select: no fill', () => {
      test('should render bottom highlight', async ({ page }) => {
        ...
        `, config);
        const select = page.locator('ion-select');
        expect(await select.screenshot({ animations: 'disabled' })).toMatchSnapshot(screenshot(`select-no-fill-highlight`));
      });
    });
    test.describe('select: solid', () => {
      test('should render bottom highlight', async ({ page }) => {
        ...
        `, config);
        const select = page.locator('ion-select');
        expect(await select.screenshot({ animations: 'disabled' })).toMatchSnapshot(screenshot(`select-solid-highlight`));
      });
    });
    test.describe('select: outline', () => {
      test('should render bottom highlight', async ({ page }) => {
        ...
        `, config);
        const select = page.locator('ion-select');
        expect(await select.screenshot({ animations: 'disabled' })).toMatchSnapshot(screenshot(`select-outline-highlight`));
      });
    });
  });
});
