  ...
  test.describe(title('input: basic'), () => {
    ...
    test.describe('input with lines="full"', () => {
      test('should not have visual regressions', async ({ page }) => {
        ...
        expect(await item.screenshot({ animations: 'disabled' })).toMatchSnapshot(screenshot(`input-with-lines-full-focused`));
      });
    });
    test.describe('input with lines="inset"', () => {
      test('should not have visual regressions', async ({ page }) => {
        ...
        expect(await item.screenshot({ animations: 'disabled' })).toMatchSnapshot(screenshot(`input-with-lines-inset-focused`));
      });
    });
    test.describe('input with lines="none"', () => {
      test('should not have visual regressions', async ({ page }) => {
        ...
        expect(await item.screenshot({ animations: 'disabled' })).toMatchSnapshot(screenshot(`input-with-lines-none-focused`));
      });
    });
