...
var require_x25519 = __commonJS({
  "node_modules/@stablelib/x25519/lib/x25519.js"(exports) {
    ...
    function scalarMult(n2, p3) {
      ...
      const a2 = gf(), b3 = gf(), c2 = gf(), d2 = gf(), e = gf(), f2 = gf();
...
// node_modules/@stablelib/salsa20/lib/salsa20.js
var require_salsa20 = __commonJS({
  "node_modules/@stablelib/salsa20/lib/salsa20.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// node_modules/@stablelib/xsalsa20/lib/xsalsa20.js
var require_xsalsa20 = __commonJS({
  "node_modules/@stablelib/xsalsa20/lib/xsalsa20.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var binary_1 = require_binary();
    var salsa20_1 = require_salsa20();
    var wipe_1 = require_wipe();
    function streamXOR(key, nonce, src2, dst, nonceInplaceCounterLength) {
      if (nonceInplaceCounterLength === void 0) {
        nonceInplaceCounterLength = 0;
      ...
      var result = salsa20_1.streamXOR(subkey, nonce.subarray(16), src2, dst, nonceInplaceCounterLength);
      wipe_1.wipe(subkey);
      return result;
    }
    exports.streamXOR = streamXOR;
    ...
    exports.stream = stream;
    var ROUNDS = 20;
    function hsalsa(key, src2, dst) {
      var x0 = 1634760805;
      var x1 = key[3] << 24 | key[2] << 16 | key[1] << 8 | key[0];
      var x22 = key[7] << 24 | key[6] << 16 | key[5] << 8 | key[4];
      var x3 = key[11] << 24 | key[10] << 16 | key[9] << 8 | key[8];
      var x4 = key[15] << 24 | key[14] << 16 | key[13] << 8 | key[12];
      var x5 = 857760878;
      var x6 = src2[3] << 24 | src2[2] << 16 | src2[1] << 8 | src2[0];
      var x7 = src2[7] << 24 | src2[6] << 16 | src2[5] << 8 | src2[4];
      var x8 = src2[11] << 24 | src2[10] << 16 | src2[9] << 8 | src2[8];
      var x9 = src2[15] << 24 | src2[14] << 16 | src2[13] << 8 | src2[12];
      var x10 = 2036477234;
...
// node_modules/@stablelib/nacl/lib/secretbox.js
var require_secretbox = __commonJS({
  "node_modules/@stablelib/nacl/lib/secretbox.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.generateKey = exports.openSecretBox = exports.secretBox = void 0;
    var xsalsa20_1 = require_xsalsa20();
    ...
    function secretBox(key, nonce, data) {
      ...
      for (let i2 = 0; i2 < 32 && i2 < data.length; i2++) {
        result[16 + i2] = data[i2] ^ firstBlock[32 + i2];
      }
      if (data.length > 32) {
      ...
      for (let i2 = 0; i2 < auth.length; i2++) {
        result[i2] = auth[i2];
      }
      (0, wipe_1.wipe)(auth);
    ...
    function openSecretBox(key, nonce, box) {
      ...
      for (let i2 = 0; i2 < 32 && i2 < ciphertext.length; i2++) {
        result[i2] = ciphertext[i2] ^ firstBlock[32 + i2];
      }
...
// node_modules/@stablelib/nacl/lib/box.js
var require_box = __commonJS({
  "node_modules/@stablelib/nacl/lib/box.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.openBox = exports.box = exports.precomputeSharedKey = exports.generateKeyPair = void 0;
    var x25519_1 = require_x25519();
    var xsalsa20_1 = require_xsalsa20();
    var secretbox_1 = require_secretbox();
    var wipe_1 = require_wipe();
    var x25519_2 = require_x25519();
    ...
    function box(theirPublicKey, mySecretKey, nonce, data) {
      const sharedKey2 = precomputeSharedKey(theirPublicKey, mySecretKey);
      const result = (0, secretbox_1.secretBox)(sharedKey2, nonce, data);
      (0, wipe_1.wipe)(sharedKey2);
      return result;
    }
    exports.box = box;
    function openBox(theirPublicKey, mySecretKey, nonce, data) {
      const sharedKey2 = precomputeSharedKey(theirPublicKey, mySecretKey);
      const result = (0, secretbox_1.openSecretBox)(sharedKey2, nonce, data);
      (0, wipe_1.wipe)(sharedKey2);
      return result;
    }
...
// node_modules/@stablelib/nacl/lib/nacl.js
var require_nacl = __commonJS({
  "node_modules/@stablelib/nacl/lib/nacl.js"(exports) {
    "use strict";
    ...
    var __exportStar2 = exports && exports.__exportStar || function(m2, exports2) {
      for (var p3 in m2)
        if (p3 !== "default" && !Object.prototype.hasOwnProperty.call(exports2, p3))
          __createBinding2(exports2, m2, p3);
    };
    Object.defineProperty(exports, "__esModule", { value: true });
    __exportStar2(require_box(), exports);
    __exportStar2(require_secretbox(), exports);
  }
});

// node_modules/@stablelib/utf8/lib/utf8.js
var require_utf8 = __commonJS({
  "node_modules/@stablelib/utf8/lib/utf8.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// node_modules/@stablelib/bytes/lib/bytes.js
  ...
  "node_modules/@stablelib/bytes/lib/bytes.js"(exports) {
    ...
    function concat2() {
      ...
      for (var i2 = 0; i2 < arguments.length; i2++) {
        totalLength += arguments[i2].length;
      }
...
// node_modules/@stablelib/x25519-session/lib/keyagreement.js
var require_keyagreement = __commonJS({
  "node_modules/@stablelib/x25519-session/lib/keyagreement.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var wipe_1 = require_wipe();
    var x25519_1 = require_x25519();
    var x25519_session_1 = require_x25519_session();
...
// node_modules/@stablelib/x25519-session/lib/x25519-session.js
var require_x25519_session = __commonJS({
  "node_modules/@stablelib/x25519-session/lib/x25519-session.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var blake2b_1 = require_blake2b();
    var x25519_1 = require_x25519();
    var keyagreement_1 = require_keyagreement();
    Object.defineProperty(exports, "X25519Session", { enumerable: true, get: function() {
      return keyagreement_1.X25519Session;
    } });
    var SESSION_KEY_LENGTH = 32;
    function serverSessionKeysFromSharedKey(sharedKey2, myPublicKey, theirPublicKey, hash = blake2b_1.BLAKE2b) {
      const state = new hash();
      if (state.digestLength !== SESSION_KEY_LENGTH * 2) {
        throw new Error("X25519: incorrect digest length");
      }
      const h3 = state.update(sharedKey2).update(theirPublicKey).update(myPublicKey).digest();
      return {
        send: h3.subarray(0, SESSION_KEY_LENGTH),
        receive: h3.subarray(SESSION_KEY_LENGTH)
      };
    }
    exports.serverSessionKeysFromSharedKey = serverSessionKeysFromSharedKey;
    function clientSessionKeysFromSharedKey(sharedKey2, myPublicKey, theirPublicKey, hash = blake2b_1.BLAKE2b) {
      const state = new hash();
      if (state.digestLength !== SESSION_KEY_LENGTH * 2) {
        throw new Error("X25519: incorrect digest length");
      }
      const h3 = state.update(sharedKey2).update(myPublicKey).update(theirPublicKey).digest();
      return {
        receive: h3.subarray(0, SESSION_KEY_LENGTH),
        send: h3.subarray(SESSION_KEY_LENGTH)
      };
    }
...
var require_qrcode = __commonJS({
  "node_modules/qrcode-svg/lib/qrcode.js"(exports, module) {
    function QR8bitByte(data) {
      ...
      this.data = data;
      this.parsedData = [];
      for (var i3 = 0, l = this.data.length; i3 < l; i3++) {
        var byteArray = [];
    ...
    QR8bitByte.prototype = {
      ...
      write: function(buffer) {
        for (var i3 = 0, l = this.parsedData.length; i3 < l; i3++) {
      ...
      for (var row = 0; row < this.modules.length; row++) {
        ...
        for (var col = 0; col < this.modules[row].length; col++) {
          ...
          if (dark) {
            ...
            qr_mc.moveTo(x3, y3);
            qr_mc.lineTo(x3 + cs3, y3);
            qr_mc.lineTo(x3 + cs3, y3 + cs3);
            qr_mc.lineTo(x3, y3 + cs3);
            qr_mc.endFill();
          }
        }
      }
    ...
    QRCodeModel.createBytes = function(buffer, rsBlocks) {
      ...
      for (var r = 0; r < rsBlocks.length; r++) {
        ...
        for (var i3 = 0; i3 < dcdata[r].length; i3++) {
          dcdata[r][i3] = 255 & buffer.buffer[i3 + offset];
        }
        offset += dcCount;
...
var require_sha256 = __commonJS({
  "node_modules/@stablelib/sha256/lib/sha256.js"(exports) {
    ...
    function hashBlocks(w3, v, p3, pos, len) {
      while (len >= 64) {
        var a2 = v[0];
        var b3 = v[1];
        var c2 = v[2];
        ...
        for (var i2 = 0; i2 < 64; i2++) {
          var t1 = (((e >>> 6 | e << 32 - 6) ^ (e >>> 11 | e << 32 - 11) ^ (e >>> 25 | e << 32 - 25)) + (e & f2 ^ ~e & g4) | 0) + (h3 + (K2[i2] + w3[i2] | 0) | 0) | 0;
...
function __asyncDelegator(o) {
  ...
  function verb(n2, f2) {
    i2[n2] = o[n2] ? function(v) {
      return (p3 = !p3) ? { value: __await(o[n2](v)), done: n2 === "return" } : f2 ? f2(v) : v;
    } : f2;
  }
}
...
function createRoot(fn2, detachedOwner) {
  const listener = Listener, owner = Owner, unowned = fn2.length === 0, current = detachedOwner === void 0 ? owner : detachedOwner, root = unowned ? {
    owned: null,
    cleanups: null,
    context: null,
    owner: null
...
function createRenderEffect(fn2, value, options) {
  const c2 = createComputation(fn2, value, false, STALE, options);
...
function createEffect(fn2, value, options) {
  ...
  const c2 = createComputation(fn2, value, false, STALE, options), s = SuspenseContext && useContext(SuspenseContext);
  if (s)
    c2.suspense = s;
...
function createMemo(fn2, value, options) {
  options = options ? Object.assign({}, signalOptions, options) : signalOptions;
  const c2 = createComputation(fn2, value, true, 0, options);
  c2.observers = null;
...
function reconcileArrays(parentNode, a2, b3) {
  let bLength = b3.length, aEnd = a2.length, bEnd = bLength, aStart = 0, bStart = 0, after = a2[aEnd - 1].nextSibling, map = null;
  while (aStart < aEnd || bStart < bEnd) {
    if (a2[aStart] === b3[bStart]) {
      aStart++;
      bStart++;
      continue;
    }
    while (a2[aEnd - 1] === b3[bEnd - 1]) {
      aEnd--;
      bEnd--;
    }
    if (aEnd === aStart) {
      ...
      parentNode.insertBefore(b3[bStart++], a2[aStart++].nextSibling);
      ...
      if (index != null) {
        if (bStart < index && index < bEnd) {
          ...
          while (++i2 < aEnd && i2 < bEnd) {
            if ((t = map.get(a2[i2])) == null || t !== index + sequence)
              break;
            sequence++;
          }
          if (sequence > index - bStart) {
            ...
            parentNode.replaceChild(b3[bStart++], a2[aStart++]);
        } else
          aStart++;
      } else
        a2[aStart++].remove();
...
function template(html, isCE, isSVG) {
  ...
  const fn2 = isCE ? () => untrack(() => document.importNode(node || (node = create2()), true)) : () => (node || (node = create2())).cloneNode(true);
  fn2.cloneNode = fn2;
  return fn2;
}
...
function normalizeIncomingArray(normalized, array, current, unwrap) {
  ...
  for (let i2 = 0, len = array.length; i2 < len; i2++) {
    let item = array[i2], prev = current && current[i2], t;
...
function read(buf, offset) {
  var res = 0, offset = offset || 0, shift = 0, counter = offset, b3, l = buf.length;
  do {
    if (counter >= l) {
      read.bytes = 0;
...
function kn(e, n2) {
  const t = fe.sharedKey(fromString2(e, p), fromString2(n2, p)), r = new import_hkdf.HKDF(import_sha256.SHA256, t).expand(X);
...
function Mn(e) {
  const n2 = (0, import_sha256.hash)(fromString2(e, x));
  return toString2(n2, p);
}
function Pe(e) {
...
function xn(e, n2) {
  const t = ee(e);
  return Re({ type: $(t.type), senderPublicKey: typeof t.senderPublicKey < "u" ? toString2(t.senderPublicKey, p) : void 0, receiverPublicKey: n2 == null ? void 0 : n2.receiverPublicKey });
}
function Re(e) {
...
function ie(e) {
  let n2 = true;
  return j(e) ? e.length && (n2 = e.every((t) => h(t, false))) : n2 = false, n2;
}
function nn(e, n2, t) {
  let r = null;
...
var Rt = class {
  constructor(e, t, i2) {
    this.core = e, this.logger = t, this.name = Qe2, this.initialized = false, this.init = async () => {
      ...
      const n2 = ee(s);
      return n2.senderPublicKey ? toString2(n2.senderPublicKey, p) : void 0;
...
var pr = class extends u {
  constructor(e, t) {
    super(e, t), this.relayer = e, this.logger = t, this.events = new import_events5.EventEmitter(), this.name = nt2, this.queue = /* @__PURE__ */ new Map(), this.publishTimeout = (0, import_time3.toMiliseconds)(import_time3.TEN_SECONDS), this.needsTransportRestart = false, this.publish = async (i2, s, n2) => {
      var a2;
...
var Ft2 = class {
  constructor(e, t) {
    this.core = e, this.logger = t, this.name = mt2, this.version = ft2, this.events = new import_events5.default(), this.initialized = false, this.storagePrefix = x2, this.ignoredPayloadTypes = [_], this.registeredMethods = [], this.init = async () => {
      ...
      this.isInitialized();
      const i2 = Dn(), s = await this.core.crypto.setSymKey(i2), n2 = lt(import_time3.FIVE_MINUTES), a2 = { protocol: at2 }, o = { topic: s, expiry: n2, relay: a2, active: false }, h3 = Nt({ protocol: this.core.protocol, version: this.core.version, topic: s, symKey: i2, relay: a2 });
      ...
      const o = lt(import_time3.FIVE_MINUTES), h3 = { topic: s, relay: a2, expiry: o, active: false };
      ...
      this.isInitialized();
      const s = lt(import_time3.THIRTY_DAYS);
  ...
  constructor(e, t) {
    super(e, t), this.core = e, this.logger = t, this.records = /* @__PURE__ */ new Map(), this.events = new import_events5.EventEmitter(), this.name = Et2, this.version = wt, this.cached = [], this.initialized = false, this.storagePrefix = x2, this.init = async () => {
      ...
      if (this.isInitialized(), this.logger.debug("Setting JSON-RPC request history record"), this.logger.trace({ type: "method", method: "set", topic: i2, request: s, chainId: n2 }), this.records.has(s.id))
        return;
      const a2 = { id: s.id, topic: i2, request: { method: s.method, params: s.params || null }, chainId: n2, expiry: lt(import_time3.THIRTY_DAYS) };
...
var kt2 = class extends y {
  constructor(e, t) {
    super(e, t), this.projectId = e, this.logger = t, this.name = X2, this.initialized = false, this.queue = [], this.verifyDisabled = false, this.init = async (i2) => {
      ...
      const a2 = this.startAbortTimer(import_time3.ONE_SECOND * 2), o = await fetch(`${s}/attestation/${i2}`, { signal: this.abortController.signal });
...
var Z2 = class _Z extends n {
  constructor(e) {
    super(e), this.protocol = ce2, this.version = Je2, this.name = W2, this.events = new import_events5.EventEmitter(), this.initialized = false, this.on = (i2, s) => this.events.on(i2, s), this.once = (i2, s) => this.events.once(i2, s), this.off = (i2, s) => this.events.off(i2, s), this.removeListener = (i2, s) => this.events.removeListener(i2, s), this.projectId = e == null ? void 0 : e.projectId, this.relayUrl = (e == null ? void 0 : e.relayUrl) || le2;
...
var ls2 = class extends S {
  constructor(r) {
    super(r), this.name = ce3, this.events = new import_events6.default(), this.initialized = false, this.ignoredPayloadTypes = [_], this.requestQueue = { state: E3.idle, queue: [] }, this.sessionRequestQueue = { state: E3.idle, queue: [] }, this.requestQueueDelay = import_time4.ONE_SECOND, this.init = async () => {
      ...
      const h3 = await this.client.core.crypto.generateKeyPair(), I = g3({ requiredNamespaces: i2, optionalNamespaces: n2, relays: a2 ?? [{ protocol: at2 }], proposer: { publicKey: h3, metadata: this.client.metadata } }, o && { sessionProperties: o }), { reject: w3, resolve: T, done: K2 } = st(import_time4.FIVE_MINUTES, oe2);
      ...
      const L3 = await this.sendRequest({ topic: l, method: "wc_sessionPropose", params: I }), ue3 = lt(import_time4.FIVE_MINUTES);
      return await this.setProposal(L3, g3({ id: L3, expiry: ue3 }, I)), { uri: p3, approval: K2 };
      ...
      try {
        ...
        const n2 = lt(import_time4.FIVE_MINUTES), o = g3({ id: i2, pairingTopic: e, expiry: n2 }, t);
...
tslib/tslib.es6.js:
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=chunk-MG5LMEH5.js.map
