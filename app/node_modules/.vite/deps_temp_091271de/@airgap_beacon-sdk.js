...
// node_modules/@airgap/beacon-blockchain-substrate/dist/esm/ui/alert/wallet-lists.js
var extensionList = [];
var desktopList = [];
var webList = [];
var iOSList = [
...
// node_modules/@airgap/beacon-blockchain-substrate/dist/esm/blockchain.js
...
// node_modules/@airgap/beacon-blockchain-substrate/dist/esm/types/message-type.js
var SubstrateMessageType;
(function(SubstrateMessageType2) {
  SubstrateMessageType2["transfer_request"] = "transfer_request";
  SubstrateMessageType2["sign_payload_request"] = "sign_payload_request";
})(SubstrateMessageType || (SubstrateMessageType = {}));

// node_modules/@airgap/beacon-blockchain-substrate/dist/esm/types/permission-scope.js
var SubstratePermissionScope;
(function(SubstratePermissionScope2) {
  SubstratePermissionScope2["transfer"] = "transfer";
  SubstratePermissionScope2["sign_payload_json"] = "sign_payload_json";
  SubstratePermissionScope2["sign_payload_raw"] = "sign_payload_raw";
})(SubstratePermissionScope || (SubstratePermissionScope = {}));

// node_modules/@airgap/beacon-blockchain-tezos/dist/esm/ui/alert/wallet-lists.js
var extensionList2 = [
  {
    "key": "spire_chrome",
...
// node_modules/@airgap/beacon-blockchain-tezos/dist/esm/blockchain.js
...
function encryptCryptoboxPayload(message, sharedKey) {
  return __awaiter3(this, void 0, void 0, function* () {
    ...
    const combinedPayload = Buffer.concat([
      nonce,
      Buffer.from((0, import_nacl.secretBox)(sharedKey, nonce, Buffer.from(message, "utf8")))
    ]);
...
function decryptCryptoboxPayload(payload, sharedKey) {
  return __awaiter3(this, void 0, void 0, function* () {
    ...
    const openBox2 = (0, import_nacl.openSecretBox)(sharedKey, nonce, ciphertext);
    if (!openBox2) {
...
var toBuffer = (message) => __awaiter3(void 0, void 0, void 0, function* () {
...
var coinlibhash = (message, size = 32) => __awaiter3(void 0, void 0, void 0, function* () {
  return (0, import_blake2b.hash)(message, size);
});
var signMessage = (message, keypair) => __awaiter3(void 0, void 0, void 0, function* () {
...
var getAccountIdentifier = (address, network) => __awaiter7(void 0, void 0, void 0, function* () {
...
var getSenderId = (publicKey) => __awaiter10(void 0, void 0, void 0, function* () {
...
var Client = class extends BeaconClient {
  ...
  addListener(transport) {
    return __awaiter11(this, void 0, void 0, function* () {
      transport.addListener((message, connectionInfo) => __awaiter11(this, void 0, void 0, function* () {
...
var getStorage = () => __awaiter15(void 0, void 0, void 0, function* () {
...
var MatrixClientStore = class {
  constructor(storage) {
    ...
    this.waitReadyPromise = new Promise((resolve, reject) => __awaiter22(this, void 0, void 0, function* () {
      try {
...
var MatrixClient = class _MatrixClient {
   ...
   */
  get joinedRooms() {
    return new Promise((resolve) => __awaiter27(this, void 0, void 0, function* () {
  ...
  start(user) {
    return __awaiter27(this, void 0, void 0, function* () {
      ...
      const initialPollingResult = new Promise((resolve, reject) => __awaiter27(this, void 0, void 0, function* () {
        yield this.poll(0, (pollingResponse) => __awaiter27(this, void 0, void 0, function* () {
        ...
        }), (error) => __awaiter27(this, void 0, void 0, function* () {
          if (!this.store.get("isRunning")) {
            reject(error);
          }
          yield this.store.update({
  ...
  createTrustedPrivateRoom(...members) {
    return __awaiter27(this, void 0, void 0, function* () {
      yield this.isConnected();
      return this.requiresAuthorization("createRoom", (accessToken) => __awaiter27(this, void 0, void 0, function* () {
  ...
  sendTextMessage(roomId, message) {
    return __awaiter27(this, void 0, void 0, function* () {
      yield this.isConnected();
      yield this.requiresAuthorization("send", (accessToken) => __awaiter27(this, void 0, void 0, function* () {
  ...
  poll(interval, onSyncSuccess, onSyncError) {
    return __awaiter27(this, void 0, void 0, function* () {
      ...
      const pollSync = (resolve, reject) => __awaiter27(this, void 0, void 0, function* () {
        ...
        try {
          ...
          if (this.isActive) {
            setTimeout(() => __awaiter27(this, void 0, void 0, function* () {
  ...
  sync() {
    return __awaiter27(this, void 0, void 0, function* () {
      return this.requiresAuthorization("sync", (accessToken) => __awaiter27(this, void 0, void 0, function* () {
...
var P2PCommunicationClient = class extends CommunicationClient {
    ...
    return __awaiter28(this, void 0, void 0, function* () {
      try {
        ...
        if (retry <= 10 && error.errcode === "M_FORBIDDEN") {
          ...
          setTimeout(() => __awaiter28(this, void 0, void 0, function* () {
  ...
  start() {
    ...
    return __awaiter28(this, void 0, void 0, function* () {
      ...
      this.initialListener = (event) => __awaiter28(this, void 0, void 0, function* () {
      ...
      client.subscribe(MatrixClientEventType.INVITE, (event) => __awaiter28(this, void 0, void 0, function* () {
        let member;
  ...
  listenForEncryptedMessage(senderPublicKey, messageCallback) {
    return __awaiter28(this, void 0, void 0, function* () {
      ...
      const sharedKey = yield this.createCryptoBoxServer(senderPublicKey, this.keyPair);
      const callbackFunction = (event) => __awaiter28(this, void 0, void 0, function* () {
  ...
  sendMessage(message, peer) {
    return __awaiter28(this, void 0, void 0, function* () {
      ...
      (yield this.client.promise).sendTextMessage(roomId, encryptedMessage).catch((error) => __awaiter28(this, void 0, void 0, function* () {
        if (error.errcode === "M_FORBIDDEN") {
          ...
          (yield this.client.promise).sendTextMessage(newRoomId, encryptedMessage).catch((error2) => __awaiter28(this, void 0, void 0, function* () {
  ...
  listenForChannelOpening(messageCallback) {
    return __awaiter28(this, void 0, void 0, function* () {
      ...
      (yield this.client.promise).subscribe(MatrixClientEventType.MESSAGE, (event) => __awaiter28(this, void 0, void 0, function* () {
  ...
  sendPairingResponse(pairingRequest) {
    return __awaiter28(this, void 0, void 0, function* () {
      ...
      (yield this.client.promise).sendTextMessage(roomId, msg).catch((error) => __awaiter28(this, void 0, void 0, function* () {
        if (error.errcode === "M_FORBIDDEN") {
          ...
          (yield this.client.promise).sendTextMessage(newRoomId, msg).catch((error2) => __awaiter28(this, void 0, void 0, function* () {
  ...
  updateRelayServer(sender) {
    return __awaiter28(this, void 0, void 0, function* () {
      ...
      const promiseArray = peers.map((peer) => __awaiter28(this, void 0, void 0, function* () {
...
var PostMessageClient = class extends MessageBasedClient {
  ...
  listenForEncryptedMessage(senderPublicKey, messageCallback) {
    return __awaiter30(this, void 0, void 0, function* () {
      ...
      const callbackFunction = (message, context) => __awaiter30(this, void 0, void 0, function* () {
        try {
  ...
  listenForChannelOpening(messageCallback) {
    return __awaiter30(this, void 0, void 0, function* () {
      const fn = (event) => __awaiter30(this, void 0, void 0, function* () {
        var _a, _b;
  ...
  connect() {
    ...
    return __awaiter31(this, void 0, void 0, function* () {
      ...
      if (knownPeers.length > 0) {
        ...
        const connectionPromises = knownPeers.map((peer) => __awaiter31(this, void 0, void 0, function* () {
          return this.listen(peer.publicKey);
        }));
...
function __awaiter32(thisArg, _arguments, P, generator) {
  function adopt(value) {
    return value instanceof P ? value : new P(function(resolve) {
      resolve(value);
    });
...
var PairOther = (props) => {
  ...
  const buttonClickHandler = (state) => {
    if (state === "p2p" && !!props.p2pPayload) {
      props.p2pPayload.then((payload) => __awaiter32(void 0, void 0, void 0, function* () {
        const serializer = new Serializer();
        const codeQR2 = yield serializer.serialize(payload);
        setQrData(codeQR2);
      }));
    } else if (state === "walletconnect" && !!props.wcPayload) {
      props.wcPayload.then((payload) => __awaiter32(void 0, void 0, void 0, function* () {
...
var dispose$1 = null;
var closeAlert = (_) => {
  return new Promise((resolve) => __awaiter32(void 0, void 0, void 0, function* () {
    if (isServer) {
...
var closeAlerts = () => __awaiter32(void 0, void 0, void 0, function* () {
  return new Promise((resolve) => __awaiter32(void 0, void 0, void 0, function* () {
    if (isServer) {
      console.log("DO NOT RUN ON SERVER");
      resolve();
...
var openAlert = (config) => __awaiter32(void 0, void 0, void 0, function* () {
  var _a, _b;
  setIsLoading(false);
  ...
  if (!isOpen$1()) {
    ...
    const extensionsUpdatedFn = (event) => __awaiter32(void 0, void 0, void 0, function* () {
    ...
    const setDefaultPayload = () => __awaiter32(void 0, void 0, void 0, function* () {
    ...
    const createWalletList = () => {
      var _a2;
      const wallets = [...desktopList3.filter((wallet) => !availableExtensions.some((extWallet) => wallet.name === extWallet.name)).map((wallet) => {
        return {
          id: wallet.key,
          key: wallet.key,
      ...
      }), ...availableExtensions.filter((newExt) => !extensionList3.some((ext) => ext.id === newExt.id)).map((wallet) => {
        var _a3, _b2, _c, _d;
        return {
          id: wallet.id,
          key: wallet.id,
    ...
    const handleClickWallet = (id) => __awaiter32(void 0, void 0, void 0, function* () {
      var _c, _d, _e, _f, _g;
      if (isLoading())
        return;
      setIsLoading(true);
    ...
    const handleClickOther = () => __awaiter32(void 0, void 0, void 0, function* () {
      var _h;
      (_h = analytics()) === null || _h === void 0 ? void 0 : _h.track("click", "ui", "other wallet");
      setCurrentInfo("qr");
    });
    const handleClickConnectExtension = () => __awaiter32(void 0, void 0, void 0, function* () {
    ...
    const handleClickInstallExtension = () => __awaiter32(void 0, void 0, void 0, function* () {
      var _q, _r, _s;
    ...
    const handleClickOpenDesktopApp = () => __awaiter32(void 0, void 0, void 0, function* () {
      var _t, _u, _v;
      setShowMoreContent(false);
    ...
    const handleClickDownloadDesktopApp = () => __awaiter32(void 0, void 0, void 0, function* () {
      var _w, _x, _y;
    ...
    dispose$1 = render(() => {
      var _a2, _b2, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q, _r, _s, _t;
      return (() => {
        const _el$ = _tmpl$$1();
...
var localDesktopList = desktopList3;
var localExtensionList = extensionList3;
var localWebList = webList3;
var localiOSList = iOSList3;
var getDesktopList = () => {
  return localDesktopList;
};
var setDesktopList = (desktopList4) => {
  localDesktopList = desktopList4;
};
var getExtensionList = () => {
  return localExtensionList;
};
var setExtensionList = (extensionList4) => {
  localExtensionList = extensionList4;
};
var getWebList = () => {
  return localWebList;
};
var setWebList = (webList4) => {
  localWebList = webList4;
};
var getiOSList = () => {
  return localiOSList;
};
...
var openToast = (config) => __awaiter32(void 0, void 0, void 0, function* () {
  if (isServer) {
    console.log("DO NOT RUN ON SERVER");
    return;
  }
...
var showSentToast = (data) => __awaiter33(void 0, void 0, void 0, function* () {
  ...
  if (data.walletInfo.deeplink) {
    if (data.walletInfo.type === "web" || data.walletInfo.type === "mobile" && isMobile(window) || data.walletInfo.type === "desktop" && !isMobile(window)) {
      ...
      openWalletAction = () => __awaiter33(void 0, void 0, void 0, function* () {
        const a = document.createElement("a");
        a.setAttribute("rel", "noopener");
        a.setAttribute("href", link);
  ...
  actions.push({
    ...
    actionCallback: () => __awaiter33(void 0, void 0, void 0, function* () {
      yield closeToast();
    })
  });
  actions.push({
...
var showAcknowledgedToast = (data) => __awaiter33(void 0, void 0, void 0, function* () {
  openToast({
...
var showPrepare = (data) => __awaiter33(void 0, void 0, void 0, function* () {
...
var hideUI = (elements) => __awaiter33(void 0, void 0, void 0, function* () {
  if (elements) {
...
var showNoPermissionAlert = () => __awaiter33(void 0, void 0, void 0, function* () {
  yield openAlert({
    title: "No Permission",
    body: "Please allow the wallet to handle this type of request."
  });
});
var showErrorToast = (response, buttons) => __awaiter33(void 0, void 0, void 0, function* () {
...
var showRateLimitReached = () => __awaiter33(void 0, void 0, void 0, function* () {
  openAlert({
    title: "Error",
...
var showExtensionConnectedAlert = () => __awaiter33(void 0, void 0, void 0, function* () {
  yield closeAlerts();
});
var showChannelClosedAlert = () => __awaiter33(void 0, void 0, void 0, function* () {
  yield openAlert({
...
var showInternalErrorAlert = (data) => __awaiter33(void 0, void 0, void 0, function* () {
  var _g;
...
var showPairAlert = (data) => __awaiter33(void 0, void 0, void 0, function* () {
...
var showPermissionSuccessAlert = (data) => __awaiter33(void 0, void 0, void 0, function* () {
  const { output } = data;
  yield openToast({
...
var showOperationSuccessAlert = (data) => __awaiter33(void 0, void 0, void 0, function* () {
...
var showSignSuccessAlert = (data) => __awaiter33(void 0, void 0, void 0, function* () {
...
var showBroadcastSuccessAlert = (data) => __awaiter33(void 0, void 0, void 0, function* () {
...
var emptyHandler = () => () => __awaiter33(void 0, void 0, void 0, function* () {
});
  ...
  emit(event, data, eventCallback) {
    return __awaiter33(this, void 0, void 0, function* () {
      ...
      if (listeners && listeners.length > 0) {
        listeners.forEach((listener) => __awaiter33(this, void 0, void 0, function* () {
          try {
...
var DappPostMessageTransport = class extends PostMessageTransport {
  ...
  startOpenChannelListener() {
    return __awaiter36(this, void 0, void 0, function* () {
      return this.client.listenForChannelOpening((peer) => __awaiter36(this, void 0, void 0, function* () {
...
var DappP2PTransport = class extends P2PTransport {
  ...
  startOpenChannelListener() {
    return __awaiter37(this, void 0, void 0, function* () {
      return this.client.listenForChannelOpening((peer) => __awaiter37(this, void 0, void 0, function* () {
...
var WalletConnectCommunicationClient = class _WalletConnectCommunicationClient extends CommunicationClient {
  ...
  listenForEncryptedMessage(senderPublicKey, messageCallback) {
    return __awaiter38(this, void 0, void 0, function* () {
      ...
      const callbackFunction = (message) => __awaiter38(this, void 0, void 0, function* () {
  ...
  listenForChannelOpening(messageCallback) {
    return __awaiter38(this, void 0, void 0, function* () {
      const callbackFunction = (pairingResponse) => __awaiter38(this, void 0, void 0, function* () {
  ...
  signPayload(signPayloadRequest) {
    return __awaiter38(this, void 0, void 0, function* () {
      ...
      }).catch(() => __awaiter38(this, void 0, void 0, function* () {
        const errorResponse = {
  ...
  init(forceNewConnection = false) {
    return __awaiter38(this, void 0, void 0, function* () {
      ...
      signClient.core.pairing.ping({ topic }).then(() => __awaiter38(this, void 0, void 0, function* () {
  ...
  getSignClient() {
    return __awaiter38(this, void 0, void 0, function* () {
      if (this.signClient === void 0) {
        this.signClient = yield us.init(this.wcOptions.opts);
...
var WalletConnectTransport = class extends Transport {
  ...
  connect() {
    ...
    return __awaiter39(this, void 0, void 0, function* () {
      ...
      const knownPeers = yield this.getPeers();
      if (knownPeers.length > 0) {
        knownPeers.map((peer) => __awaiter39(this, void 0, void 0, function* () {
          return this.listen(peer.publicKey);
        }));
      }
      yield this.startOpenChannelListener();
...
var DappWalletConnectTransport = class extends WalletConnectTransport {
  constructor(name, keyPair, storage, wcOptions) {
    ...
    this.client.listenForChannelOpening((peer) => __awaiter40(this, void 0, void 0, function* () {
      yield this.addPeer(peer);
      this._isConnected = TransportStatus.CONNECTED;
      if (this.newPeerListener) {
        this.newPeerListener(peer);
...
var DAppClient = class extends Client {
  constructor(config) {
    ...
    this.activeAccountLoaded = this.storage.get(StorageKey.ACTIVE_ACCOUNT).then((activeAccountIdentifier) => __awaiter41(this, void 0, void 0, function* () {
    ...
    })).catch((storageError) => __awaiter41(this, void 0, void 0, function* () {
      yield this.setActiveAccount(void 0);
      console.error(storageError);
    }));
    this.handleResponse = (message, connectionInfo) => __awaiter41(this, void 0, void 0, function* () {
  ...
  init(transport) {
    ...
    return __awaiter41(this, void 0, void 0, function* () {
      ...
      this._initPromise = new Promise((resolve) => __awaiter41(this, void 0, void 0, function* () {
        if (transport) {
          ...
          if (activeAccount && activeAccount.origin) {
            ...
            PostMessageTransport.getAvailableExtensions().then((extensions2) => __awaiter41(this, void 0, void 0, function* () {
  ...
  showPrepare() {
    return __awaiter41(this, void 0, void 0, function* () {
      const walletInfo = yield (() => __awaiter41(this, void 0, void 0, function* () {
        try {
  ...
  permissionRequest(input) {
    return __awaiter41(this, void 0, void 0, function* () {
      ...
      const { message: response, connectionInfo } = yield this.makeRequestV3(request).catch((_requestError) => __awaiter41(this, void 0, void 0, function* () {
  ...
  request(input) {
    return __awaiter41(this, void 0, void 0, function* () {
      ...
      const { message: response, connectionInfo } = yield this.makeRequestV3(request).catch((requestError) => __awaiter41(this, void 0, void 0, function* () {
  ...
  requestPermissions(input) {
    ...
    return __awaiter41(this, void 0, void 0, function* () {
      ...
      const { message, connectionInfo } = yield this.makeRequest(request).catch((requestError) => __awaiter41(this, void 0, void 0, function* () {
    ...
    return __awaiter41(this, void 0, void 0, function* () {
      ...
      if (beaconError.errorType) {
        ...
        if (beaconError.errorType === BeaconErrorType.NO_PRIVATE_KEY_FOUND_ERROR) {
          const actionCallback = () => __awaiter41(this, void 0, void 0, function* () {
  ...
  makeRequest(requestInput) {
    ...
    return __awaiter41(this, void 0, void 0, function* () {
          ...
          buttons: [
            {
              ...
              actionCallback: () => __awaiter41(this, void 0, void 0, function* () {
                yield closeToast();
                this.disconnect();
              })
            }
      ...
      this.events.emit(messageEvents[requestInput.type].sent, {
        ...
        extraInfo: {
          resetCallback: () => __awaiter41(this, void 0, void 0, function* () {
            this.disconnect();
          })
        }
      }).catch((emitError) => console.warn(emitError));
...
// node_modules/@airgap/beacon-wallet/dist/esm/client/WalletClient.js
var import_axios4 = __toESM(require_axios());

// node_modules/@airgap/beacon-wallet/dist/esm/transports/WalletP2PTransport.js
...
var WalletP2PTransport = class extends P2PTransport {
  constructor(name, keyPair, storage, matrixNodes, iconUrl, appUrl) {
...
// node_modules/@airgap/beacon-wallet/dist/esm/interceptors/IncomingRequestInterceptor.js
...
var logger16 = new Logger("IncomingRequestInterceptor");
var IncomingRequestInterceptor = class _IncomingRequestInterceptor {
  /**
  ...
  static intercept(config) {
    return __awaiter43(this, void 0, void 0, function* () {
      ...
      if (config.message.version === "2") {
        _IncomingRequestInterceptor.handleV2Message(config);
      } else if (config.message.version === "3") {
        _IncomingRequestInterceptor.handleV3Message(config);
      }
    });
  }
  ...
  static handleV2Message(config) {
    return __awaiter43(this, void 0, void 0, function* () {
      ...
      switch (message.type) {
        ...
        case BeaconMessageType.OperationRequest:
          {
            const appMetadata = yield _IncomingRequestInterceptor.getAppMetadata(appMetadataManager, message.senderId);
        ...
        case BeaconMessageType.BroadcastRequest:
          ...
          break;
        default:
          logger16.log("intercept", "Message not handled");
          assertNever2(message);
      }
    });
  }
  static handleV3Message(config) {
    return __awaiter43(this, void 0, void 0, function* () {
      ...
      switch (v3Message.type) {
        case BeaconMessageType.PermissionRequest:
          {
            yield appMetadataManager.addAppMetadata(Object.assign(Object.assign({}, v3Message.blockchainData.appMetadata), { senderId: msg.senderId }));
            const request = wrappedMessage;
            interceptorCallback(request, connectionInfo);
          }
          break;
        case BeaconMessageType.BlockchainRequest:
          {
            const request = Object.assign({}, wrappedMessage);
            interceptorCallback(request, connectionInfo);
          }
          break;
        default:
          logger16.log("intercept", "Message not handled");
          assertNever2(v3Message);
      }
    });
  }
};
function assertNever2(_message) {
  throw new Error("Function not implemented.");
}

// node_modules/@airgap/beacon-wallet/dist/esm/interceptors/OutgoingResponseInterceptor.js
...
var logger17 = new Logger("OutgoingResponseInterceptor");
var OutgoingResponseInterceptor = class _OutgoingResponseInterceptor {
  static intercept(config) {
    return __awaiter44(this, void 0, void 0, function* () {
      if (config.request.version === "2") {
        _OutgoingResponseInterceptor.handleV2Message(config);
      } else if (config.request.version === "3") {
        _OutgoingResponseInterceptor.handleV3Message(config);
      }
    });
  }
  static handleV3Message(config) {
    ...
    return __awaiter44(this, void 0, void 0, function* () {
      ...
      switch (message.type) {
        case BeaconMessageType.Error: {
          ...
          if (message.errorType === BeaconErrorType.TRANSACTION_INVALID_ERROR && message.errorData) {
            ...
            if (Array.isArray(errorData) && errorData.every((item) => Boolean(item.kind) && Boolean(item.id))) {
              ...
              logger17.warn("ErrorData provided is not in correct format. It needs to be an array of RPC errors. It will not be included in the message sent to the dApp");
            }
          }
        ...
        case BeaconMessageType.BroadcastResponse:
          ...
          break;
        default:
          logger17.log("intercept", "Message not handled");
          assertNever3(message);
      }
    });
  }
};
function assertNever3(_message) {
  throw new Error("Function not implemented.");
}
...
var logger18 = new Logger("WalletClient");
var WalletClient = class extends Client {
  ...
  connect(newMessageCallback) {
    return __awaiter45(this, void 0, void 0, function* () {
      this.handleResponse = (message, connectionContext) => __awaiter45(this, void 0, void 0, function* () {
        if (message.version === "3") {
          const typedMessage = message;
  ...
  getRegisterPushChallenge(backendUrl, accountPublicKey, oracleUrl = NOTIFICATION_ORACLE_URL) {
    return __awaiter45(this, void 0, void 0, function* () {
      const challenge = (yield import_axios4.default.get(`${oracleUrl}/challenge`)).data;
      const constructedString = [
        "Tezos Signed Message: ",
        challenge.id,
        challenge.timestamp,
  ...
  registerPush(challenge, signature, backendUrl, accountPublicKey, protocolIdentifier, deviceId, oracleUrl = NOTIFICATION_ORACLE_URL) {
    return __awaiter45(this, void 0, void 0, function* () {
      const tokens = yield this.storage.get(StorageKey.PUSH_TOKENS);
      const token = tokens.find((el) => el.publicKey === accountPublicKey && el.backendUrl === backendUrl);
      if (token) {
        return token;
      }
      const register = (yield import_axios4.default.post(`${oracleUrl}/register`, {
        name: this.name,
        challenge,
        accountPublicKey,
        signature,
      ...
      yield this.storage.set(StorageKey.PUSH_TOKENS, tokens);
      return newToken;
    });
  }
  /**
  ...
  _connect() {
    return __awaiter45(this, void 0, void 0, function* () {
      ...
      if (transport.connectionStatus === TransportStatus.NOT_CONNECTED) {
        ...
        transport.addListener((message, connectionInfo) => __awaiter45(this, void 0, void 0, function* () {
          if (typeof message === "string") {
            const deserializedMessage = yield new Serializer().deserialize(message);
            this.handleResponse(deserializedMessage, connectionInfo);
          }
        })).catch((error) => logger18.log("_connect", error));
  ...
  respond(message) {
    return __awaiter45(this, void 0, void 0, function* () {
      ...
      yield OutgoingResponseInterceptor.intercept({
        ...
        appMetadataManager: this.appMetadataManager,
        interceptorCallback: (response) => __awaiter45(this, void 0, void 0, function* () {
...
//# sourceMappingURL=@airgap_beacon-sdk.js.map
