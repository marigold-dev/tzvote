...
var PostMessageClient = class extends MessageBasedClient {
  ...
  listenForEncryptedMessage(senderPublicKey, messageCallback) {
    return __awaiter25(this, void 0, void 0, function* () {
      ...
      const callbackFunction = (message, context) => __awaiter25(this, void 0, void 0, function* () {
        try {
  ...
  listenForChannelOpening(messageCallback) {
    return __awaiter25(this, void 0, void 0, function* () {
      const fn = (event) => __awaiter25(this, void 0, void 0, function* () {
        var _a, _b;
...
function __awaiter27(thisArg, _arguments, P, generator) {
  function adopt(value) {
    return value instanceof P ? value : new P(function(resolve) {
      resolve(value);
    });
...
var openAlert = (config) => __awaiter27(void 0, void 0, void 0, function* () {
  var _a, _b;
...
var openToast = (config) => __awaiter27(void 0, void 0, void 0, function* () {
  if (isServer) {
    console.log("DO NOT RUN ON SERVER");
    return;
  }
...
var WalletConnectCommunicationClient = class _WalletConnectCommunicationClient extends CommunicationClient {
  ...
  listenForEncryptedMessage(senderPublicKey, messageCallback) {
    return __awaiter33(this, void 0, void 0, function* () {
      ...
      const callbackFunction = (message, context) => __awaiter33(this, void 0, void 0, function* () {
    ...
    return __awaiter33(this, void 0, void 0, function* () {
      ...
      (_a = this.signClient) === null || _a === void 0 ? void 0 : _a.request({
        ...
        const sendOperationResponse = {
          ...
          transactionHash: (_c = (_b = (_a2 = response.operationHash) !== null && _a2 !== void 0 ? _a2 : response.transactionHash) !== null && _b !== void 0 ? _b : response.hash) !== null && _c !== void 0 ? _c : "",
          id: this.currentMessageId
        };
  ...
  init(forceNewConnection = false) {
    ...
    return __awaiter33(this, void 0, void 0, function* () {
      ...
      this.signClient = yield us.init(this.wcOptions);
...
function __awaiter37(thisArg, _arguments, P, generator) {
  function adopt(value) {
    return value instanceof P ? value : new P(function(resolve) {
      resolve(value);
    });
...
var BeaconWallet = class {
  ...
  sign(bytes, watermark) {
    return __awaiter37(this, void 0, void 0, function* () {
      ...
      const watermarkedBytes = buf2hex((0, import_typedarray_to_buffer.default)(bb));
