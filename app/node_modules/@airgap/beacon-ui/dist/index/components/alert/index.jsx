...
const Alert = (props) => {
    ...
    return (<div class={props.open ? 'alert-wrapper-show' : 'alert-wrapper-hide'} onClick={() => {
            props.onCloseClick();
        }}>
      <div class={props.open ? 'alert-modal-show' : 'alert-modal-hide'} onClick={(e) => {
            e.stopPropagation();
        }}>
        <div class="alert-header">
          {props.onBackClick && (<div class="alert-button-icon" onClick={props.onBackClick}>
              <LeftIcon />
            </div>)}
        ...
        <div class="alert-modal-loading-wrapper" style={props.loading
            ? {
                opacity: 1,
        ...
        <div class="alert-body" style={{ 'margin-bottom': props.extraContent ? '' : '1.8em' }}>
          {props.content}
          {!isMobile && (<div class={props.showMore ? 'alert-body-extra-show' : 'alert-body-extra-hide'}>
              {props.extraContent && <div class="alert-divider"></div>}
              {props.extraContent}
            </div>)}
        </div>
        {!isMobile && props.extraContent && (<div class="alert-footer" onClick={() => {
