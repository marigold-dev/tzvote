...
const QR = (props) => {
    ...
    return (<div class="qr-wrapper" style={props.isMobile
            ? {
      ...
      <div class="qr-left">
        ...
        {!props.isMobile && (<span>{`Open ${props.walletName} Wallet on your mobile phone and scan.`}</span>)}
        {props.isMobile && (<span>
            {`Scan QR code with a ${props.isWalletConnect ? 'WalletConnect' : 'Beacon'}-compatible wallet.`}
            {props.onClickLearnMore && (<span class="qr-more-info" onClick={() => {
        ...
        {!props.isMobile && props.onClickLearnMore && (<span style={{ 'margin-top': 'auto' }} class="qr-more-info" onClick={() => {
                if (props.onClickLearnMore)
                    props.onClickLearnMore();
            }}>
            Learn more
      ...
      <div class="qr-right" style={props.isMobile ? { 'background-color': 'transparent' } : {}} onClick={handleCopyClipboard}>
        {div}
        {copied() && (<div class="qr-copy-wrapper">
