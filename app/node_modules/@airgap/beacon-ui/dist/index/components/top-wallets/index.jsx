...
const TopWallets = (props) => {
    return (<div class="top-wallets-wrapper">
      ...
      <div class="top-wallets-wallets-main">
        <For each={props.wallets}>
          {(wallet) => (<Wallet disabled={props.disabled} mobile={props.isMobile} name={wallet.name} description={wallet.descriptions.join(' & ')} image={wallet.image} onClick={() => props.onClickWallet(wallet.id)} tags={wallet.tags}/>)}
        </For>
        {props.otherWallets && (<div class="top-wallets-other-wallets" onClick={() => {
            ...
            <div class="top-wallets-other-wallets-right">
              ...
              <img class="top-wallets-other-wallets-center-wallet" src={props.otherWallets.images[1]}/>
