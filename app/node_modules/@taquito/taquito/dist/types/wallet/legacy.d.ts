...
export declare class LegacyWalletProvider implements WalletProvider {
    ...
    mapOriginateParamsToWalletParams(params: () => Promise<WalletOriginateParams>): Promise<import("../operations/types").withKind<WalletOriginateParams<any>, OpKind.ORIGINATION>>;
