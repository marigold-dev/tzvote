        ...
        dispose = render(() => (<div class={`theme__${colorMode}`}>
          {config.pairingPayload && (<Alert loading={isLoading()} open={isOpen()} showMore={showMoreContent()} content={<div>
                  ...
                  <div style={currentInfo() !== 'install' &&
                    ...
                    <TopWallets disabled={isLoading()} wallets={isMobile ? walletList().slice(0, 3) : walletList().slice(0, 4)} onClickWallet={handleClickWallet} onClickLearnMore={handleClickLearnMore} otherWallets={isMobile
                        ? {
                            images: [
                                walletList()[3].image,
                                walletList()[4].image,
