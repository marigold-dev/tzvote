...
const _tmpl$$a = /*#__PURE__*/web.template(`<svg stroke-width="0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" height="1em" width="1em"><path d="m289.94 256 95-95A24 24 0 0 0 351 127l-95 95-95-95a24 24 0 0 0-34 34l95 95-95 95a24 24 0 1 0 34 34l95-95 95 95a24 24 0 0 0 34-34Z"></path></svg>`, 4),
...
const _tmpl$$9 = /*#__PURE__*/web.template(`<div class="loader"></div>`, 2);
const Loader = _ => {
  return _tmpl$$9.cloneNode(true);
};

const _tmpl$$8 = /*#__PURE__*/web.template(`<div><div><div class="alert-header"><div class="alert-logo"></div><div class="alert-button-icon"></div></div><div class="alert-modal-loading-wrapper"></div><div class="alert-body"></div></div></div>`, 14),
  _tmpl$2$7 = /*#__PURE__*/web.template(`<div class="alert-button-icon"></div>`, 2),
  _tmpl$3$6 = /*#__PURE__*/web.template(`<div class="alert-button-icon-empty"></div>`, 2),
  _tmpl$4$5 = /*#__PURE__*/web.template(`<div></div>`, 2),
  _tmpl$5$5 = /*#__PURE__*/web.template(`<div class="alert-divider"></div>`, 2),
  _tmpl$6$3 = /*#__PURE__*/web.template(`<div class="alert-footer"></div>`, 2);
const Alert = props => {
...
const _tmpl$$7 = /*#__PURE__*/web.template(`<div></div>`, 2),
  _tmpl$2$6 = /*#__PURE__*/web.template(`<div><div><h3></h3></div><div class="wallet-main-right"><img></div></div>`, 9),
  _tmpl$3$5 = /*#__PURE__*/web.template(`<p></p>`, 2),
  _tmpl$4$4 = /*#__PURE__*/web.template(`<div class="wallet-main-tags"></div>`, 2),
  _tmpl$5$4 = /*#__PURE__*/web.template(`<span class="wallet-main-tag"></span>`, 2),
  _tmpl$6$2 = /*#__PURE__*/web.template(`<div class="wallet-small"><img><h3></h3></div>`, 5);
const Wallet = props => {
  return (() => {
...
const _tmpl$$6 = /*#__PURE__*/web.template(`<div class="top-wallets-wrapper"><div class="top-wallets-info"><h3>Connect Wallet</h3><span>If you don't have a wallet, you can select a provider and create one now. <span class="top-wallets-learn-more">Learn more</span></span></div><div class="top-wallets-wallets-main"></div></div>`, 12),
  _tmpl$2$5 = /*#__PURE__*/web.template(`<div class="top-wallets-other-wallets"><div class="top-wallets-other-wallets-left"><h3>Other Wallets</h3><p>See other wallets you can use to connect</p></div><div class="top-wallets-other-wallets-right"><img><img class="top-wallets-other-wallets-center-wallet"><img></div></div>`, 13);
const TopWallets = props => {
  ...
  return (() => {
    ...
    web.insert(_el$8, (() => {
      ...
      return () => _c$() && (() => {
        const _el$9 = _tmpl$2$5.cloneNode(true),
...
const _tmpl$$5 = /*#__PURE__*/web.template(`<div class="wallets-list-main-wrapper"><div class="wallets-list-wrapper"></div><button class="wallets-button"></button></div>`, 6);
const Wallets = props => {
  return (() => {
...
const _tmpl$$4 = /*#__PURE__*/web.template(`<div><h3 class="info-title"></h3><div class="info-buttons"></div></div>`, 6),
  _tmpl$2$4 = /*#__PURE__*/web.template(`<div></div>`, 2),
  _tmpl$3$4 = /*#__PURE__*/web.template(`<div class="info-description"></div>`, 2),
  _tmpl$4$3 = /*#__PURE__*/web.template(`<pre class="info-data"></pre>`, 2),
  _tmpl$5$3 = /*#__PURE__*/web.template(`<button></button>`, 2);
const Info = props => {
  return (() => {
...
const _tmpl$$3 = /*#__PURE__*/web.template(`<div class="qr-wrapper"><div class="qr-left"></div><div class="qr-right"></div></div>`, 6),
  _tmpl$2$3 = /*#__PURE__*/web.template(`<h3>Or scan to connect</h3>`, 2),
  _tmpl$3$3 = /*#__PURE__*/web.template(`<span></span>`, 2),
  _tmpl$4$2 = /*#__PURE__*/web.template(`<span class="qr-more-info">Learn more</span>`, 2),
...
const _tmpl$$2 = /*#__PURE__*/web.template(`<div><span class="pair-other-info">Select QR Type</span><br></div>`, 5),
  _tmpl$2$2 = /*#__PURE__*/web.template(`<button class="wallets-button">Beacon</button>`, 2),
  _tmpl$3$2 = /*#__PURE__*/web.template(`<button class="wallets-button">WalletConnect</button>`, 2);
...
const _tmpl$$1 = /*#__PURE__*/web.template(`<div></div>`, 2),
  _tmpl$2$1 = /*#__PURE__*/web.template(`<div><div></div><div></div><div></div></div>`, 8),
  ...
  if (!isOpen$1()) {
    ...
    const handleClickWallet = id => __awaiter(void 0, void 0, void 0, function* () {
      ...
      if (wallet && ((_d = wallet.supportedInteractionStandards) === null || _d === void 0 ? void 0 : _d.includes('wallet_connect'))) {
        ...
        setIsLoading(false);
      } else if ((wallet === null || wallet === void 0 ? void 0 : wallet.types.includes('ios')) && isMobile) {
        setCodeQR('');
        if (config.pairingPayload) {
          const serializer = new beaconCore.Serializer();
          const code = yield serializer.serialize(yield p2pPayload);
    ...
    const handleClickConnectExtension = () => __awaiter(void 0, void 0, void 0, function* () {
      ...
      setShowMoreContent(false);
      if ((_j = config.pairingPayload) === null || _j === void 0 ? void 0 : _j.postmessageSyncCode) {
        const serializer = new beaconCore.Serializer();
    ...
    const handleClickOpenDesktopApp = () => __awaiter(void 0, void 0, void 0, function* () {
      var _r, _s, _t;
      setShowMoreContent(false);
      (_r = analytics()) === null || _r === void 0 ? void 0 : _r.track('click', 'ui', 'open desktop', {
        key: (_s = currentWallet()) === null || _s === void 0 ? void 0 : _s.key
      });
      if (p2pPayload) {
        const serializer = new beaconCore.Serializer();
        const code = yield serializer.serialize(yield p2pPayload);
        const link = getTzip10Link(((_t = currentWallet()) === null || _t === void 0 ? void 0 : _t.deepLink) || '', code);
        window.open(link, '_blank', 'noopener');
      }
    });
            ...
            get content() {
              return (() => {
                ...
                web.insert(_el$5, web.createComponent(TopWallets, {
                  ...
                  get wallets() {
                    return isMobile ? walletList().slice(0, 3) : walletList().slice(0, 4);
                  },
                  onClickWallet: handleClickWallet,
                  onClickLearnMore: handleClickLearnMore,
                  get otherWallets() {
...
const _tmpl$ = /*#__PURE__*/web.template(`<img>`, 1),
  _tmpl$2 = /*#__PURE__*/web.template(`<h3></h3>`, 2),
  _tmpl$3 = /*#__PURE__*/web.template(`<p class="toast-label"></p>`, 2),
  _tmpl$4 = /*#__PURE__*/web.template(`<div><div class="toast-header"><div class="toast-button-icon"></div></div></div>`, 6),
  _tmpl$5 = /*#__PURE__*/web.template(`<p class="toast-label">props.label</p>`, 2),
  _tmpl$6 = /*#__PURE__*/web.template(`<div class="toast-action-button">Open Wallet</div>`, 2),
  _tmpl$7 = /*#__PURE__*/web.template(`<div class="toast-body"></div>`, 2),
  _tmpl$8 = /*#__PURE__*/web.template(`<div class="toast-action-wrapper"><p></p></div>`, 4),
  _tmpl$9 = /*#__PURE__*/web.template(`<div class="toast-action-button"></div>`, 2);
...
const Toast = props => {
  ...
  return (() => {
    ...
    web.insert(_el$5, !hasWalletObject && _tmpl$5.cloneNode(true), _el$6);
    web.insert(_el$5, (() => {
    ...
    web.effect(() => web.className(_el$4, props.open ? 'toast-wrapper-show' : 'toast-wrapper-hide'));
    return _el$4;
  })();
};
web.delegateEvents(["click"]);
