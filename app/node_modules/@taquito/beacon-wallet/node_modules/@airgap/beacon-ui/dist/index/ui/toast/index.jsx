...
const createToast = (config) => {
    ...
    dispose = render(() => (<Toast label={config.body} open={isOpen()} onClickClose={() => {
            closeToast();
        }} actions={config.actions} walletInfo={config.walletInfo} openWalletAction={config.openWalletAction}/>), shadowRoot);
    // Create toast
