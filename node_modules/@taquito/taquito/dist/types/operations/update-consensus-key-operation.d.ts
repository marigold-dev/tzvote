...
import { FeeConsumingOperation, ForgedBytes, GasConsumingOperation, RPCUpdateConsensusKeyOperation, StorageConsumingOperation } from './types';
/**
 *
...
export declare class UpdateConsensusKeyOperation extends Operation implements GasConsumingOperation, StorageConsumingOperation, FeeConsumingOperation {
    ...
    constructor(hash: string, params: RPCUpdateConsensusKeyOperation, source: string, raw: ForgedBytes, results: OperationContentsAndResult[], context: Context);
