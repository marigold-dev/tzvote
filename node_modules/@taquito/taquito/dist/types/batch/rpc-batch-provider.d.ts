...
import { ActivationParams, DelegateParams, OriginateParams, RPCOperation, TransferParams, ParamsWithKind, RegisterGlobalConstantParams, TxRollupOriginateParams, TxRollupBatchParams, TransferTicketParams, IncreasePaidStorageParams } from '../operations/types';
...
export declare class OperationBatch extends OperationEmitter {
     ...
     */
    withTxRollupOrigination(params?: TxRollupOriginateParams): this;
    /**
     *
    ...
    toPrepare(): Promise<RPCOperation[]>;
    /**
     *
