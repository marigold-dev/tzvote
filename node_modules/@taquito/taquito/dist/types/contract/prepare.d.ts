import { OriginateParams, RPCOriginationOperation, TransferParams, RPCTransferOperation, DelegateParams, RPCDelegateOperation, RegisterDelegateParams, RPCRevealOperation, RevealParams, RegisterGlobalConstantParams, RPCRegisterGlobalConstantOperation, TxRollupOriginateParams, RPCTxRollupOriginationOperation, TxRollupBatchParams, RPCTxRollupBatchOperation, TransferTicketParams, RPCTransferTicketOperation, IncreasePaidStorageParams, RPCIncreasePaidStorageOperation, DrainDelegateParams, RPCDrainDelegateOperation, BallotParams, RPCBallotOperation, ProposalsParams, RPCProposalsOperation, UpdateConsensusKeyParams, RPCUpdateConsensusKeyOperation } from '../operations/types';
...
export declare const createTxRollupOriginationOperation: ({ source, fee, gasLimit, storageLimit, }: TxRollupOriginateParams) => Promise<RPCTxRollupOriginationOperation>;
export declare const createTxRollupBatchOperation: ({ content, rollup, source, fee, gasLimit, storageLimit, }: TxRollupBatchParams) => Promise<RPCTxRollupBatchOperation>;
