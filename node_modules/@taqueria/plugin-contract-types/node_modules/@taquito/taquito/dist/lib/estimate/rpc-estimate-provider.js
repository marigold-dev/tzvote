    ...
    transfer(_a) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (toValidation !== utils_1.ValidationResult.VALID) {
                throw new core_1.InvalidAddressError(rest.to, utils_1.invalidErrorDetail(toValidation));
            }
            ...
            if (rest.source && srouceValidation !== utils_1.ValidationResult.VALID) {
                throw new core_1.InvalidAddressError(rest.source, utils_1.invalidErrorDetail(srouceValidation));
            }
    ...
    transferTicket(_a) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (destinationValidation !== utils_1.ValidationResult.VALID) {
                throw new core_1.InvalidAddressError(rest.destination, utils_1.invalidErrorDetail(destinationValidation));
            }
            ...
            if (rest.source && sourceValidation !== utils_1.ValidationResult.VALID) {
                throw new core_1.InvalidAddressError(rest.source, utils_1.invalidErrorDetail(sourceValidation));
            }
            const protocolConstants = yield this.context.readProvider.getProtocolConstants('head');
    ...
    setDelegate(_a) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (rest.delegate && delegateValidation !== utils_1.ValidationResult.VALID) {
                throw new core_1.InvalidAddressError(rest.delegate, utils_1.invalidErrorDetail(delegateValidation));
            }
