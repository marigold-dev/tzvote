...
class WalletOperation {
    ...
    constructor(opHash, context, _newHead$) {
        ...
        }), operators_1.tap((newHead) => (this.lastHead = newHead)), operators_1.publishReplay(1), operators_1.refCount());
        ...
        }), operators_1.first(), operators_1.publishReplay(1), operators_1.refCount());
