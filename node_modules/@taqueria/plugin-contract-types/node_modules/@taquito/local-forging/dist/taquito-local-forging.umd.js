(function (global, factory) {
  ...
  const pkhEncoder = (val) => {
      ...
      switch (pubkeyPrefix) {
          ...
          default:
              throw new utils.InvalidKeyHashError(val, utils.invalidErrorDetail(utils.ValidationResult.NO_PREFIX_MATCHED) +
  ...
  const publicKeyEncoder = (val) => {
      ...
      switch (pubkeyPrefix) {
          ...
          default:
              throw new utils.InvalidPublicKeyError(val, utils.invalidErrorDetail(utils.ValidationResult.NO_PREFIX_MATCHED) +
  ...
  const addressEncoder = (val) => {
      ...
      switch (pubkeyPrefix) {
          ...
          default:
              throw new core.InvalidAddressError(val, utils.invalidErrorDetail(utils.ValidationResult.NO_PREFIX_MATCHED) +
  ...
  const smartRollupAddressEncoder = (val) => {
      if (val.substring(0, 3) !== utils.Prefix.SR1) {
          throw new InvalidSmartRollupAddressError(val, utils.invalidErrorDetail(utils.ValidationResult.NO_PREFIX_MATCHED) + ` expecting prefix '${utils.Prefix.SR1}'.`);
      }
  ...
  const smartContractAddressEncoder = (val) => {
      ...
      throw new core.InvalidContractAddressError(val, utils.invalidErrorDetail(utils.ValidationResult.NO_PREFIX_MATCHED) + ` expecting prefix '${utils.Prefix.KT1}'.`);
  };
  const publicKeyDecoder = (val) => {
      ...
      switch (preamble[0]) {
          ...
          default:
              throw new utils.InvalidPublicKeyError(val.toString(), utils.invalidErrorDetail(utils.ValidationResult.NO_PREFIX_MATCHED));
      }
  };
  const smartRollupCommitmentHashEncoder = (val) => {
      ...
      throw new InvalidSmartRollupCommitmentHashError(val, utils.invalidErrorDetail(utils.ValidationResult.NO_PREFIX_MATCHED) + ` expecting prefix '${utils.Prefix.SRC1}'`);
  };
  ...
  const smartRollupAddressDecoder = (val) => {
      ...
      if (address.substring(0, 3) !== utils.Prefix.SR1) {
          throw new InvalidSmartRollupAddressError(address, utils.invalidErrorDetail(utils.ValidationResult.NO_PREFIX_MATCHED) + ` expecting prefix '${utils.Prefix.SR1}'.`);
      }
      return address;
  };
  const smartContractAddressDecoder = (val) => {
      ...
      throw new core.InvalidContractAddressError(val.toString(), utils.invalidErrorDetail(utils.ValidationResult.NO_PREFIX_MATCHED));
  };
  const smartRollupCommitmentHashDecoder = (val) => {
      ...
      if (address.substring(0, 4) !== utils.Prefix.SRC1) {
          throw new InvalidSmartRollupCommitmentHashError(address, utils.invalidErrorDetail(utils.ValidationResult.NO_PREFIX_MATCHED) + ` expecting prefix '${utils.Prefix.SRC1}'`);
      }
      return address;
  };
  ...
  class LocalForger {
      ...
      forge(params) {
          ...
          if (branchValidation !== utils.ValidationResult.VALID) {
              throw new core.InvalidBlockHashError(params.branch, utils.invalidErrorDetail(branchValidation));
          }
