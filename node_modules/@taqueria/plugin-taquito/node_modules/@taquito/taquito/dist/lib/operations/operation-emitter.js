            ...
            ops.find((op) => __awaiter(this, void 0, void 0, function* () {
                if (op.kind === 'ballot' || op.kind === 'proposals') {
                    try {
                        ...
                        throw new errors_1.RPCResponseError(`Failed to get the current voting period index`, e);
                    }
                }
            }));
    ...
    estimate(_a, estimator) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (calculatedFee && calculatedFee % 1 !== 0) {
                throw new errors_2.InvalidEstimateValueError(`Fee value must not be a decimal: ${calculatedFee}`);
            }
            if (calculatedGas && calculatedGas % 1 !== 0) {
                throw new errors_2.InvalidEstimateValueError(`Gas Limit value must not be a decimal: ${calculatedGas}`);
            }
            if (calculatedStorage && calculatedStorage % 1 !== 0) {
                throw new errors_2.InvalidEstimateValueError(`Storage Limit value must not be a decimal: ${calculatedStorage}`);
            }
    ...
    signAndInject(forgedBytes) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!Array.isArray(results)) {
                throw new errors_2.TezosPreapplyFailureError(results);
            }
            ...
            const errors = errors_2.flattenErrors(results);
            if (errors.length) {
                throw new errors_2.TezosOperationError(errors, 'Error occurred during validation simulation of operation');
            }
            return {
